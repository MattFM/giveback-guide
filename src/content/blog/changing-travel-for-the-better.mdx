...
description: "Join our mission to transform travel for communities, wildlife and the planet. Learn how we're tackling climate change, overtourism and exploitation while creating more authentic, sustainable experiences for mindful global travellers."
slug: "changing-travel-for-the-better"
...
We’ve realised that **we (the *Give Back Guide* team) have a greater role to play in fixing our broken planet** and we really hope you’ll join us. We’re using this moment in our planet’s journey through space and time to announce some changes to the way we do things, but the truth is, we’ve been slowly pivoting our approach for months.
...
![](https://res.cloudinary.com/dnxl7wsnx/image/upload/v1744905884/no-planet-b-1024x683.jpg_kuwn0t.webp)
